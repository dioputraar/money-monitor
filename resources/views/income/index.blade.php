...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <button class="btn btn-primary float-right" onclick="add()">Add Income</button>
            </div>
            <div class="card-body">
        ...
        {{-- modal --}}
        <div class="modal fade" id="IncomeModal" tabindex="-1" role="dialog" aria-labelledby="addIncomeModalLabel"
            aria-hidden="true">
    ...
    @section('scripts')
        <script>
            ...
            function add() {
                clear();
                $('#addIncomeModalLabel').text('Add Income');
            ...
            function edit(id) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#addIncomeModalLabel').text('Edit Income');
                        $('#IncomeModal').modal('show');
                    }
                });
            }
            ...
            function setCategory() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.data.filter(category => category.type === 1).forEach(function(category) {
